...
namespace Projet1
{
    class Competition_equipe : Competition
    {
        ...
        public Competition_equipe(int ns,int nd, List<Match_simple> l_s,List<Match_double> l_d, List<char> r,string l, List<Joueur_competition> l_e, int[] c, int nb_j, string n, int niv, int nb_j_m,int annee_min, int annee_max,DateTime date_debut) : base(l, l_e,nb_j, n, niv, nb_j_m, annee_min, annee_max, date_debut)
        {
